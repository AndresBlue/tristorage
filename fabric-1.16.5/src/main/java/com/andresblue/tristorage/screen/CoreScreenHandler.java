...
public final class CoreScreenHandler extends ScreenHandler {
    ...
    public boolean onButtonClick(PlayerEntity player, int id) {
        ...
        if (removed > 0) {
            player.inventory.offerOrDrop(player.world, new ItemStack(Items.CHEST, removed));
            return true;
        }
        return false;
    }
    ...
    public ItemStack transferSlot(PlayerEntity player, int slotIndex) {
        ...
        } else if (source.getItem() == Items.CHEST) {
    ...
    private static PropertyDelegate properties(StorageCoreBlockEntity core) {
        return new PropertyDelegate() {
            ...
            public int get(int index) {
                ...
                switch (index) {
                    case 0: return core.installedChests();
                    case 1: return core.maxChests();
                    case 2: return core.storedTypes();
                    case 3: return core.typeCapacity();
                    case 4: return (int) total;
                    case 5: return (int) (total >>> 32);
                    case 6: return (int) capacity;
                    case 7: return (int) (capacity >>> 32);
                    default: return 0;
                }
            }
