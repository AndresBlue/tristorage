...
final class RemoteLoadPolicy {
    ...
    static final int MAX_IDLE_WARM_CHUNKS = 16;
    static final int REQUEST_TIMEOUT_TICKS = 20 * 30;
    static final int WARM_SESSION_TICKS = 20 * 60 * 5;
    ...
    static boolean withinIdleWarmChunkBudget(int chunkCount) {
        return chunkCount >= 0 && chunkCount <= MAX_IDLE_WARM_CHUNKS;
    }
}
